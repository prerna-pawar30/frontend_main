...
export const API_ROUTES = {
  ...
  SEND_OTP: `${BASE_URL}${VERSION}/librarylog/send-otp`,
  VERIFY_OTP: `${BASE_URL}${VERSION}/librarylog/verify-otp`,
  ...
  GET_BLOGS: `${BASE_URL}${VERSION}/blog/blogs`,
  GET_BLOG_BY_ID: (id) => `${BASE_URL}${VERSION}/blog/blogs/${id}`,
