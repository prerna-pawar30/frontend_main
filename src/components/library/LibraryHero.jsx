        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex justify-center md:justify-end">
            <button
              ...
              className="group flex items-center justify-center gap-3 w-full md:w-auto bg-white hover:bg-[#E68736] hover:text-white text-[#E68736] border border-white px-6 md:px-8 py-3.5 md:py-4 rounded-xl md:rounded-2xl font-black text-[10px] md:text-xs uppercase tracking-widest transition-all shadow-xl active:scale-95"
            >
