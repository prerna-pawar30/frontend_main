      ...
      <div className="w-full max-w-6xl px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center min-h-[520px] mb-20">
          ...
          >
            ...
            >
              CuraVex™{" "}
              <span className="text-[#0b2230]">Abutment</span>
              <br />
            ...
            <motion.div variants={fadeInUp} className="space-y-3">
              <p className="text-[#0b2230] text-lg leading-relaxed font-medium">
                ...
                <span className="text-[#E68736] font-bold">
                  CuraVex™ Abutment System
                </span>{" "}
                sets a new benchmark in precision, offering micro-level
                customization for optimal tissue adaptation and superior
                clinical outcomes.
              </p>
              <p className="text-[#0b2230] text-base leading-relaxed opacity-80">
                Designed for unmatched accuracy, it provides precise height
                control to ensure proper prosthetic seating and balanced load
                distribution, significantly enhancing patient comfort and
                long-term restoration health.
              </p>
            </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
            ...
            >
              ...
              <p className="text-[#0b2230] text-lg leading-relaxed font-medium">
                The system offers height variations from 250 µm to 3000 µm,
                enabling clinicians to achieve an exact tissue fit that prevents
                food lodgement.
              </p>
              <p className="text-[#0b2230] text-base leading-relaxed opacity-80">
                This flexibility ensures optimal emergence profiles and hygienic
                restorations, effectively managing challenging implant positions
                while maintaining superior aesthetics.
              </p>
            </motion.section>
            ...
            >
              ...
              <p className="text-[#0b2230] text-lg leading-relaxed font-medium">
                Equipped with a specialized Ti-base adjustment tool, allowing
                for seamless modification of abutment height from 6.5 mm down
                to 3.5 mm.
              </p>
              <p className="text-[#0b2230] text-base leading-relaxed opacity-80">
                Integrated 55° markings provide a visual guide for precise
                customization, ensuring accuracy during the adjustment process
                for stable prosthetic seating.
              </p>
            </motion.section>
          </div>
